                ...
                <div class="col-md-6 col-sm-6">
                    <div class="home-thumb">
                        <div class="section-title">
                            ...
                            <a href="#about" class="wow fadeInUp smoothScroll section-btn btn btn-success"
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="about-thumb">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.8s">
                            <p>Phasellus vulputate tellus nec tortor varius elementum. Curabitur at pulvinar ante. Duis
                                dui urna, faucibus eget felis eu, iaculis congue sem. Mauris convallis eros massa.</p>
                            <p>Quisque viverra iaculis aliquam. Etiam volutpat, justo non aliquam bibendum, sem nibh
                                mollis erat, quis porta odio odio at velit.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="bg-yellow col-md-3 col-sm-6">
                    <div class="wow fadeInUp color-white service-thumb" data-wow-delay="0.8s">
                        ...
                        <p class="color-white">Phasellus vulputate tellus nec tortor varius elementum. Curabitur at
                            pulvinar ante.</p>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="wow fadeInUp color-white service-thumb" data-wow-delay="1.2s">
                        ...
                        <p class="color-white">Curabitur at pulvinar ante. Duis dui urna, faucibus eget felis eu,
                            iaculis congue sem.</p>
                    </div>
                </div>
                ...
                <div class="bg-dark col-md-3 col-sm-6">
                    <div class="wow fadeInUp color-white service-thumb" data-wow-delay="1.6s">
                        ...
                        <h3>Mobile App</h3>
                        <p class="color-white">Mauris convallis eros massa, vitae euismod arcu tempus ut. Quisque
                            viverra iaculis.</p>
                    </div>
                </div>
                    ...
                    <div class="color-white experience-thumb">
                        ...
                        <div class="wow fadeInUp color-white media" data-wow-delay="1.2s">
                            ...
                            <div class="media-body">
                                <h3 class="media-heading">Graphic Designer
                        ...
                        <div class="wow fadeInUp color-white media" data-wow-delay="1.6s">
                            ...
                            <div class="media-body">
                                <h3 class="media-heading">Web Designer
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="color-white education-thumb">
                        ...
                        <div class="wow fadeInUp color-white media" data-wow-delay="1.2s">
                            ...
                            <div class="media-body">
                                <h3 class="media-heading">Master in Design
                                    <small>2012 Jan - 2014 May</small>
                                </h3>
                                <p class="color-white">Etiam iaculis elit in mauris ullamcorper auctor. Proin a sapien
                                    id orci ullamcorper dignissim eu in neque. </p>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-10 col-sm-12">
                    ...
                    <h2 class="wow fadeInUp" data-wow-delay="0.8s">Proin lobortis eu diam et facilisis. Fusce nisi nibh,
                        molestie in vestibulum quis, auctor et orci.</h2>
                    <p class="wow fadeInUp" data-wow-delay="1s">Curabitur at pulvinar ante. Duis dui urna, faucibus eget
